...
function buildCss(){
  ...
  css += `${selector} .card-header.starred::before{content:"${starIcon}" !important;margin-right:8px;}\n`;
  css += `${selector} .card-header.hearted::before{content:"${heartIcon}" !important;margin-right:8px;}\n\n`;
  ...
  css += `${avatarMediaSelector}:hover{transform:scale(1.08) translateY(-4px);border-color:${primary} !important;box-shadow:0 0 45px ${rgba(primary,0.80)}, 0 0 120px ${rgba(secondary,0.45)}, 0 0 200px ${rgba(primary,0.25)}, 0 30px 80px rgba(0,0,0,0.95) !important;filter:saturate(1.15) brightness(1.08);}\n\n`;
